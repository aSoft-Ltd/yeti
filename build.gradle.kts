...
subprojects {
    ...
    configure<MavenPublishBaseExtension> {
        ...
        pom {
            ...
            url.set("https://github.com/aSoft-Ltd/yeti")
            licenses {
                license {
                    name.set("MIT License")
                    url.set("https://github.com/aSoft-Ltd/yeti/blob/master/LICENSE")
                }
            }
            developers {
                developer {
            ...
            scm {
                url.set("https://github.com/aSoft-Ltd/yeti/")
                connection.set("scm:git:git://github.com/aSoft-Ltd/yeti.git")
                developerConnection.set("scm:git:ssh://git@github.com/aSoft-Ltd/yeti.git")
            }
        }
    }
}
